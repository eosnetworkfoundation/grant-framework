...
Milestones are to be delivered on the [Grant Milestone Delivery](https://github.com/eosnetworkfoudation/Grant-Milestones/) repository following the [process](https://github.com/eosnetworkfoundation/Grant-Milestones#milestone-delivery-process) described therein.
