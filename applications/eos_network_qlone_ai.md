...
### Milestone 1 - EOS Network integration
...
| -----: | ----------- | ------------- |
| 1. | License | MIT |
| 2. | Documentation | We will provide both Qlone.ai application techincal documentation of the code in https://github.com/QLONEAI/ repo readme.md file and a basic user manual with detailed instruction how to use AI NFT generator on EOS Network chain for unique NFTs collections. |
| 3. | Testing Guide | All available application functionalities will be live tested and also sandbox tested in Jungle testnet. test.md will cover detailed instruction how to use AI NFT generator |
| 1. | Research EOS Network usage for AI (artificial intelligence) NFT generator tool to integrate in EOS blockchain, using the Alcor.exchange. | |  
| 2. | AI (artificial intelligence) based NFT Generator development for NFTs collection on WEB platform with preparation to syncronize functionality with EOS blockchain ecosystem | |
| 3. | Integration of wallet that supports the EOS blockchain, such as Scatter in aplication to be able to connect and use AI NFT generator on  Jungle testnet. Test contracts development on Jungle testnet | |  
...
| -----: | ----------- | ------------- |
| 1. | License | MIT |
| 2. | Documentation | We will provide both Qlone.ai application techincal documentation of the code in https://github.com/QLONEAI/ repo readme.md file and a basic user manual with detailed instruction how to use AI NFT generator on EOS blockchain for unique NFTs collections. |
...
| 1. | Fix and update EOS blockchain contracts for EOS blockchain mainnet chain | |  
| 2. | Fully integration of EOS blockchain on to NFT generator to generate and synchronize collections NFTs minting in EOS blockchain | |  
| 3. | Ability to manage NFT collections using wallet that supports the EOS blockchain, such as Scatter for selling, tranfering and editing NFTs metadata on EOS blockchain | | 
