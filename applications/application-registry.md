...
| 1. | Application Registry Indexing Service | This service will provide a variety of insights of the Application Registry smart contract data. This will serve both the Web interface (see next deliverable), but also other applications or wallets that might want to make use of this data. The indexing service will be configured so that it can support other EOSIO chains in the future. |  
