...
- **Project Name:** EOSIO Fake Test Project
- **Team Name:** EOSIO Code Warriers, LLC
...
This is a Fake Test project by Ted Cahall to test the grant submission system.

### Overview

- This is a fake project.  If it were a real prohect, you would be asked to log off and head for cover.
- This project relates to EOSIO as it allows future grants to be made to contributing teams.
- The team is interested in creating this project to test the grant framework submission process.
...
- Name of team leader: Ted Cahall
- Names of team members: None
...
### Legal Structure
- **Registered Legal Entity:** EOSIO Code Warriors, LLC
- **Registered Address:** 123 Main St. Anytown, VA, USA
### Team Experience
...
- https://github.com/tedcahalleos

Please also provide the GitHub accounts of all team members. If they contain no activity, references to projects hosted elsewhere or live are also fine.

- https://github.com/tedcahall/MarrsRename
- https://github.com/tedcahall/resume
