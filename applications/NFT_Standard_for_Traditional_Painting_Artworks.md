...
- **Brief Description:** A set of exclusive NFT standards that combine the NFT functions on EOS blockchain, and apply to the characteristics of traditional painting artworks (Hereinafter referred to as TPA), protect the artistic copyrights of TPA original manuscripts and the corresponding NFTs. Help to bring the huge TPA market potential into the NFT ecosystem on EOS.
...
- **The core content of the standard**:
  - A condensed paper statement indicating that the original manuscript implements NS-TPA.
  - The statement is pasted on the back of the work, and signed by the artist + stamped with a cross-page seal.
  - When uploading and generating NFT Templete, add an electronic statement in it, indicating that this NFT has implemented NS-TPA, and Mint #1 is bound to the original manuscript.
  - The NFT Template will be signed by the artist's EOS account.

- **Standard Features**: 
  - **Easy to learn**. There are only a few steps to complete this standard, each artist can use it easily after a simple learning. 
...
This v1.0 of the standard is still relatively simple and incomplete. But our project has got [about 89 contributions on Pomelo](https://pomelo.io/grants/nftart), representing the enthusiasm and support from the EOS community to NS-TPA. We believe that if this set of standards can be further optimized and promoted, and gain wider adoption and consensus, it will definitely attract more artists and NFT enthusiasts to EOS.
