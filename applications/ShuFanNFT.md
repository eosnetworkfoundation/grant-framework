...
- **Build a brand**. The current ShuFan NFT project has formed a small team (After discussion by the team, this Level 1 grant plan is applied in the name of ShuFan.), now has its own [official web](https://shufannft.carrd.co/) and other media platforms, committed to building ShuFan NFT as a brand IP.
...
- The recently released popular work is the [panda series](https://eos.atomichub.io/profile/shufan.free#sets-shufan.free-0-0), which includes 4 panda-related illustrations, and refreshed the highest price of one mint (100 $EOS) and single sale (150 $EOS). 
- At present, the basic settings of [NFT project on EOS](https://eos.atomichub.io/profile/shufan.free#listings) management, the structure of the media platform([Twitter](https://twitter.com/ShuFanNFT), [Website](https://shufannft.carrd.co/), [Discord](https://discord.gg/NkJAnGK9ZA), [Telegram](https://t.me/ShuFanNFT), [Instagram](https://www.instagram.com/shufannft), etc.), and the IP construction of the "ShuFan NFT" brand have been basically completed.
...
- **Cooperate with blockchain games**: ShuFan NFT is now cooperating with Wombate on EOS, who developed a NFT pledged game named [Dungeon Master](https://dungeon.wombat.app/dungeon), which increased the playability value and fun of NFT, beyond the collection value of artworks.
...
- **Illustration competitions**. ShuFan is also participating in many international illustration competitions, including Europe, Japan, Australia, USA, etc. Once these illustrations are awarded, NFTs are expected to be first launched on EOS.
